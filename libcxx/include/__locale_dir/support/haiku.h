...
// TODO: consider replacing with #include <stdio.h> and
// adding /boot/home/haiku/headers/compatibility/bsd to the header search paths
// but right now ain't nobody got no time for that
#ifdef __cplusplus
extern "C" {
#endif
